...
<liferay-ui:success key="article-delete"
    message="article-deleted-message" />
<liferay-ui:success key="article-up-down"
    message="article-up-down-message" />
<liferay-ui:success key="article-default"
    message="article-default-message" />
...
<div class="portet-announcer-edit">
    ...
    <aui:form method="POST" action="${actionURL}" name="fm">
        <liferay-ui:search-container delta="10"
            ...
            <liferay-ui:search-container-row modelVar="article"
