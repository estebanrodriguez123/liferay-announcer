 ...
 * {@link com.rivetlogic.portlet.service.NotCompletedLocalService} interface.
 * 
 * <p>
 ...
 */
public class NotCompletedLocalServiceImpl extends
        NotCompletedLocalServiceBaseImpl {
    /*
     * NOTE FOR DEVELOPERS:
     * 
     * Never reference this interface directly. Always use {@link
     * com.rivetlogic.portlet.service.NotCompletedLocalServiceUtil} to access
     * the not completed local service.
     */

    private static Log LOG = LogFactoryUtil
            .getLog(NotCompletedLocalServiceImpl.class);
    ...
    public NotCompleted addNotCompleted(NotCompleted newUser)
        ...
        NotCompleted NotCompleted = notCompletedPersistence.create(onbNCPK);
    ...
    public List<NotCompleted> NotCompletedAllUsers() {
        List<NotCompleted> allUsers = new ArrayList<NotCompleted>();
        int usersCount;

        try {
            usersCount = NotCompletedLocalServiceUtil.getNotCompletedsCount();
            allUsers = NotCompletedLocalServiceUtil.getNotCompleteds(0,
                    usersCount);
