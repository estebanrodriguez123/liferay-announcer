 ...
 * {@link com.rivetlogic.portlet.service.CompletedLocalService} interface.
 * 
 * <p>
...
public class CompletedLocalServiceImpl extends CompletedLocalServiceBaseImpl {
     ...
     * com.rivetlogic.portlet.service.CompletedLocalServiceUtil} to access the
     * completed local service.
     */

    private static Log LOG = LogFactoryUtil
            .getLog(CompletedLocalServiceImpl.class);

    @Override
    public Completed addCompleted(Completed newUser) throws SystemException {
        CompletedPK onbCPK = new CompletedPK();

        Completed completed = completedPersistence.create(onbCPK);
    ...
    public Completed deleteCompleted(CompletedPK user) throws SystemException,
            PortalException {
    ...
    public List<Completed> CompletedAllUsers() {
        List<Completed> allUsers = new ArrayList<Completed>();
        int usersCount;

        try {
            usersCount = CompletedLocalServiceUtil.getCompletedsCount();
            allUsers = CompletedLocalServiceUtil.getCompleteds(0, usersCount);
