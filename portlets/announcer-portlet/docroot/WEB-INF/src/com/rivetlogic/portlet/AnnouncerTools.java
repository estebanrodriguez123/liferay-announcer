...
public class AnnouncerTools {
    ...
    private static boolean isSameArticlesSetId(String userId, String layoutPK,
        ...
        try {
            ...
            Completed user = CompletedLocalServiceUtil
                    .getCompleted(userLayoutPKC);
    ...
    private static boolean showNotCompleted(String userId, String layoutPK) {
        ...
        try {
            NotCompleted user = NotCompletedLocalServiceUtil
                    .getNotCompleted(userLayoutPKNC);
    ...
    public static void addToCompleted(String userId, String layoutPK,
        ...
        Completed newCompleted = CompletedLocalServiceUtil
                .createCompleted(userLayoutPKC);
    ...
    public static void addToNotCompleted(String userId, String layoutPK,
        ...
        NotCompleted newNotCompleted = NotCompletedLocalServiceUtil
                .createNotCompleted(userLayoutPKNC);
        newNotCompleted.setPANEL_CLOSE_DATE(panelCloseDate);

        try {
            if (isNotCompleted(userId, layoutPK)) { // Delete to update new not
                                                    // completed
                deleteNotCompleted(userId, layoutPK);
            }
            NotCompletedLocalServiceUtil.addNotCompleted(newNotCompleted);

            if (isCompleted(userId, layoutPK)) { // If userId exist on Completed
                                                 // table, delete it
                deleteCompleted(userId, layoutPK); // Can happen if article set
                                                   // id has change
